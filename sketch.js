...
function preload(){
    //------------------------FONT-------------------------------
    gameFont = loadFont('assets/font/gameFont.ttf')
    //-----------JSON FILE----------------------------------------
    ...
    //------------------------------------------------------------
    //-----------------EXPLOSION ANIMATION -----------------------
    explosionAnim = loadAnimation('assets/explosions/expl1.png','assets/explosions/expl2.png','assets/explosions/expl3.png','assets/explosions/expl4.png','assets/explosions/expl5.png','assets/explosions/expl6.png','assets/explosions/expl7.png','assets/explosions/expl8.png','assets/explosions/expl9.png','assets/explosions/expl10.png')
    //--------------------VIDEO----------------------------------
    video = createVideo(['assets/Video/video1.mp4']);
    //------------------------------------------------------------
    //---------------SOUNDS---------------------------------------
    explSound = loadSound('assets/Sounds/explosionSound.wav');
    laserSound = loadSound('assets/Sounds/laser.wav');
    enemySound = loadSound('assets/sounds/launch.wav');
    ...
    //------------------------------------------------------------
    //---------------IMAGES---------------------------------------
    rocketImg = loadImage('assets/rockets/rockets.png'); 
    scoreTitle = loadImage('assets/Text/score.png');
    airDropImg = loadImage('assets/SpaceShip.png');
    cityImg = loadImage('assets/City.png');
    crossHairImg1 = loadImage('assets/crosshair/crosshair1.png'); 
    crossHairImg2 = loadImage('assets/crosshair/crosshair.png'); 
    attackImage = loadImage('assets/rockets/attack.png'); 
    backgroundImage = loadImage('assets/background.png');
    plane = loadImage('assets/SpaceShip.png');
    title = loadImage('assets/Text/title.png');
    blownCity = loadImage ('assets/explodedCity.png');
    creditTitle = loadImage('assets/Text/credits.png');
    leaderboardTitle = loadImage('assets/Text/leaderboard.png');
    missile = loadImage('assets/rockets/spr_missile.png');
    ...
    smokeImg = loadImage('assets/rockets/smoke.png');
    //------------------------------------------------------------
}
...
function draw(){
    ...
    // -------------menu page button setup -------------------
        ...
        leaderB.position(width/2-250,height/2+150)
        leaderB.size(500,50)
        leaderB.style('color','red')
        leaderB.mouseClicked(leaderBoardPage)
        creditsB.style('font-size','20px')
        ...
        creditsB.position(width/2-250,height/2+250)
